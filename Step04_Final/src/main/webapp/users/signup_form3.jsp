...
<body>
	...
	<div class="container" id="app">
		...
		<form action="signup.jsp" method="post" id="signupForm">
			<div>
			 	...
			 	<input v-bind:class="idClass" type="text" class="form-control" name="id" id="id" />
			...
			<div>
				...
				<input v-bind:class="pwdClass" type="password" class="form-control" name="pwd" id="pwd" />
	...
	<script>
		...
		//아래의 코드를 Vue.js를 활용한 구조로 변경해 보세요.
		new Vue({
			el:"#app"
			data:{
				idClass:false
			...
			methods:{
				computed:{
	                idClass:function(){
	                    return {'is-invalid':this.idClass, 'btn-lg':this.isLg};
			}
		})
